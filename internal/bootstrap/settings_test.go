...
func TestNewBaseSettingsMapsConfig(t *testing.T) {
	cfg := config.Config{
		...
		SandboxCubeAPIURL:         "https://cube-api.internal",
		SandboxCubeAPIKey:         "cube-key",
		SandboxCubeTemplateID:     "tpl-1",
		SandboxCubeProxyNodeIP:    "10.0.0.12",
		SandboxCubeProxyPortHTTP:  443,
		SandboxCubeProxyScheme:    "https",
		SandboxCubeDomain:         "cube.internal",
		SandboxCubeClusterID:      "cluster-1",
		SandboxCubeRequestTimeout: 25 * time.Second,
		SandboxCubePauseTimeout:   35 * time.Second,
		SandboxCubeMaxOutputBytes: 2048,
		SandboxCubeAllowOut:       []string{"api.example.com"},
		SandboxCubeDenyOut:        []string{"0.0.0.0/0"},
	}
	...
	if settings.Sandbox.Cube.APIURL != "https://cube-api.internal" || settings.Sandbox.Cube.TemplateID != "tpl-1" || settings.Sandbox.Cube.ProxyPortHTTP != 443 || settings.Sandbox.Cube.RequestTimeout != 25*time.Second {
