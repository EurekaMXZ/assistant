...
const (
	...
	ConversationEventInteractionAwaiting   = "interaction.awaiting_input"
	ConversationEventInteractionCompleted  = "interaction.completed"
	ConversationEventInteractionCancelled  = "interaction.cancelled"
