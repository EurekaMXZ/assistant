...
func (a *API) registerRoutes(router *gin.Engine) {
	...
	userRoutes.GET("/profile/personalization", a.handleGetPersonalization)
	userRoutes.PUT("/profile/personalization", a.handleUpdatePersonalization)
	userRoutes.GET("/profile/location", a.handleGetLocation)
	userRoutes.PUT("/profile/location", a.handleUpdateLocation)
	userRoutes.DELETE("/profile/location", a.handleDeleteLocation)
	userRoutes.GET("/mcp-servers", a.handleListMCPServers)
	userRoutes.POST("/mcp-servers", a.handleCreateMCPServer)
	userRoutes.GET("/mcp-servers/:serverID", a.handleGetMCPServer)
	userRoutes.PATCH("/mcp-servers/:serverID", a.handleUpdateMCPServer)
	userRoutes.DELETE("/mcp-servers/:serverID", a.handleDeleteMCPServer)
	userRoutes.POST("/mcp-servers/:serverID/test", a.handleTestMCPServer)
	...
	userRoutes.POST("/billing/redemptions", a.handleRedeemBillingCode)
	...
	userRoutes.GET("/storage", a.handleGetStorage)
	userRoutes.DELETE("/storage/attachments/:attachmentID", a.handleDeleteStorageAttachment)
	...
	userRoutes.DELETE("/conversations/:conversationID", a.handleDeleteConversation)
	...
	userRoutes.POST("/turns/:turnID/cancel", a.handleCancelTurn)
	userRoutes.POST("/turns/:turnID/tool-calls/:toolCallID/answer", a.handleAnswerToolCall)
	...
	adminRoutes.DELETE("/users/:userID", a.handleDeleteManagedUser)
	...
	systemRoutes.DELETE("/admin/models/:modelID", a.handleDeleteModel)
